...
SERVICE_METNO = "metno"
SERVICE_SMHI  = "smhi"
DEFAULT_SERVICE = SERVICE_METNO

SERVICEPROVIDERS_MAP = {
    SERVICE_METNO : {
        "name": "Met.no",
        "description": "Meteorologisk institutt (Met.no)",
        "website": "https://met.no/en"
    },
    SERVICE_SMHI : {
        "name": "SMHI",
        "description": "Sveriges Meteorologiska och Hydrologiska Institut",
        "website": "https://smhi.se/en"
    }
}
